...
def TakeExcecution():
    while True:
                ...
                if 'wikipedia' in query:
                    ...
                    speak("Oh ok sir ! I will not distrub you until call me back, as it is your study time. By the way should I play any study music ?")
                    study_music = takeCommand().lower()
                    if 'yes' in study_music:
                        speak("Playing your favourite study music , ok sir concentrate !")
                        webbrowser.open("https://www.youtube.com/watch?v=mg7netw1JuM")
                    
                    else:
                        speak("Ok sir ! not playing study music")
                   ...
                   speak("The temperature in bahrain is "+temp + "updated")
                    ...
                    speak("Opening the time table")
                    os.startfile("C:\\Users\\Lenovo\\Desktop\\GRADE.pdf")
                    ...
                    speak("inoperating the modules , exited from the Jarvis Command module")
                    break
